...
```{r simple histograms and current statistics log_model, fig.height=6, fig.width=10}
...
```{r simple histograms and current statistics log_model2, fig.height=6, fig.width=10}
